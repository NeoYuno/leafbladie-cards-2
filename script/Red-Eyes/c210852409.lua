...
function s.costfilter(c)
	return c:IsSetCard(0x3b) and c:IsType(TYPE_SPELL) and c:IsAbleToGraveAsCost()
end
...
function s.spfilter(c,e,tp)
	return c:IsCode(210852408) and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP)
end
