...
s.listed_names={62651957,65622692,64500000,91998119}
...
function s.sprfilter(c)
	return c:IsCode(62651957,65622692,64500000) and c:IsAbleToRemoveAsCost()
end
...
function s.sprtg(e,tp,eg,ep,ev,re,r,rp,chk,c)
	local g=Duel.GetMatchingGroup(s.sprfilter,tp,LOCATION_ONFIELD+LOCATION_GRAVE,0,nil)
	local rg=aux.SelectUnselectGroup(g,e,tp,3,3,s.rescon,1,tp,HINTMSG_REMOVE,nil,nil,true)
	if #rg>0 then
		rg:KeepAlive()
		e:SetLabelObject(rg)
		return true
