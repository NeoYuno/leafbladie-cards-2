...
function s.descost(e,tp,eg,ep,ev,re,r,rp,chk)
    local b1=Duel.IsExistingMatchingCard(s.costfilter2,tp,LOCATION_DECK+LOCATION_HAND,0,2,nil)
    ...
    if b1 and b2 then
        if Duel.SelectYesNo(tp,aux.Stringid(id,0)) then
            ...
            local g=Duel.GetMatchingGroup(s.costfilter2,tp,LOCATION_DECK+LOCATION_HAND,0,nil)
            if #g>2 then
