...
function s.thfilter(c)
    return c:IsSetCard(0x2066) or c:IsCode(54734082,94940436,100000571,170000115,450000357,80352158,511002567,4740489,17841166,77133792,211040033) and c:IsAbleToHand()
end
