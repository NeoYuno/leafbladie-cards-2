...
s.listed_names={6022371,85066822,43017476,22587018,58071123} -- Cluster, Water Dragon, Duoterion, Hydrogeddon, Oxygeddon
function s.cfilter(c,code)
	return aux.IsCodeOrChemist(c,code) and c:IsAbleToDeckAsCost()
end
